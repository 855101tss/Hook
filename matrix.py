...
def execute_attack(user_id, target, port, time):
    ...
    try:
        ...
        full_command = f"./sahil {target} {port} {time} 100"  # Replace with actual attack command
        ...
        if len(command) == 4:
            ...
            try:
                ...
                if port < 10003 or port > 29999:
                    ...
                    record_command_logs(user_id, '/sahil', target, port, time)
